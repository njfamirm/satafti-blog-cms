...
export interface ApiReadingListReadingList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['Reference', 'Blog', 'Blog Post', 'Video', 'Project']> &
      Attribute.Required &
      Attribute.DefaultTo<'Blog Post'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::reading-list.reading-list', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::reading-list.reading-list', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
